...
const en: AboutProfileContent = {
  ...
  capabilities: [
    ...
    { title: "Supply", description: "Supplying salt products to customer requirements across local and international markets." },
  ],
...
const fr: AboutProfileContent = {
  ...
  capabilities: [
    ...
    { title: "Fourniture", description: "Fourniture de produits salins selon les exigences des clients sur les marchés locaux et internationaux." },
  ],
...
const de: AboutProfileContent = {
  ...
  capabilities: [
    ...
    { title: "Lieferung", description: "Lieferung von Salzprodukten nach Kundenanforderungen an lokale und internationale Märkte." },
  ],
